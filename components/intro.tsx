...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-medium">Hello, my name is Brett.</span> I am a designer, builder and{" "}
        <span className="font-bold underline">full-stack developer</span> that can go from design to implementation.
      </motion.h1>
